...
export default function ChangePasswordPage() {
    ...
    if (error) {
      ...
      setErrorMessage(
        error.code === "reauthentication_needed"
          ? "เซสชันนี้ต้องยืนยันตัวตนใหม่ กรุณาออกจากระบบแล้วเข้าสู่ระบบอีกครั้ง"
  ...
  return (
    <div className="mx-auto w-full max-w-lg p-4 py-8 md:p-8">
      <div className="rounded-lg bg-white p-6 shadow-sm">
        ...
        {success ? (
          <div className="mt-6 space-y-4">
            ...
            <Link href="/" className="flex min-h-[44px] items-center justify-center rounded-md bg-accent px-4 py-2 text-sm font-medium text-white">
              กลับไปหน้าแรก
            </Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            ...
            <Link href="/" className="block min-h-[44px] py-3 text-center text-sm font-medium text-accent hover:underline">
