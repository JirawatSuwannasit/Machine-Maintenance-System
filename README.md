...
หน้า `/forgot-password` ถูกนำออกจาก source code แล้ว เมื่อ deploy commit ล่าสุด ผู้ใช้ที่ยังไม่เข้าสู่ระบบและเปิด URL นี้จะถูก middleware ส่งไป `/login` และจะไม่มีแบบฟอร์มส่งอีเมลกู้รหัสผ่าน
